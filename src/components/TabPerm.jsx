  ...
  return (
    <div>
      <div className="qi-layout">
        <div>
          <div className="card">
            <div className="card-hdr">➕ Tambah Permintaan</div>
        ...
        <div>
          ...
          {filtered.length === 0 ? (
            <div className="card"><div className="empty"><div className="empty-icon">📋</div><p>{data.length === 0 ? 'Belum ada permintaan' : 'Tidak ada data di rentang tanggal ini'}</p></div></div>
          ) : groups.map(([tgl, rows]) => {
